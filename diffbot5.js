        ...
        Data.map(async element => {
            try {
                ...
                if (DiffBot.Diffstatus == 200) {
                    ...
                    var jobDesc = await getBigMLLabel(start, 'Description', joburl, Html, DiffBot.DiffBotPlainText, 'no_model', 'http://jobiak-description.vpc.bigml.com/predict/label/jobdescription/');
                    console.log(jobDesc);
                    ...
                    var jobDesc = await getBigMLLabel(start, 'Description', joburl, Html, PlainText, 'region', 'http://ijiraq.dev.bigml.com:8443/predict/label/jobdescription/');
                    var pageLabels = {},
                        Description = '';
                    if (jobDesc.hasOwnProperty('value')) {
                        let Dataset = jobDesc.value
