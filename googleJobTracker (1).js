...
var server_uri = 'mongodb://jobiak:jobiak@3.18.238.8:28015/data_cleansing';
const width = 1366,
    height = 768;
...
app.get("/", async (req, res) => {
    ...
    const Data = await db.collection('tags_h4_tracking').find({

        "jobUrl": "https://jobiak.cengage.com/job/independence-ky-shipping-3rd-shift?id=5514504178",
        ...
        try {
            ...
            for (let index = 0; index < Data.length; index++) {
                ...
                if (OriginalURL.indexOf("https://www.google.com/sorry/index?continue=") >= 0) {
                    ...
                    console.log("-------------------------------------------------------------------");
                    // await db.collection('tags_h4_tracking').updateOne({
                    //     '_id': element._id
                    // }, {
                    //     $set: {
                    //         "blockedStatus": 1
