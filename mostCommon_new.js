...
var testingArray1 = require('./variables/var11.js');
var request = require("request");
var rp = require('request-promise');
var roundround = require("roundround")
var arrayCounter = require("array-counter");
var servers = ['http://34.221.8.108:8121/htmlPlainText',
...
function endsWithUrl(url) {
    ...
    var Patterns = ['maps?q=', 'login', '.pdf', '/content/', '/local-resources/', "listing-category", "listing_type", '/resources/', '&pageno=', '/about-Us/', 'aboutus', 'contactus', 'sign-in', '/about/careers/', '/social-responsibility/',
        '/jobs/job-search/', '/postings/all', '&page=', 'page_job=', '/search/', '/job-areas/', '/job-search/', '/about-us/', '/community/', '/research/',
